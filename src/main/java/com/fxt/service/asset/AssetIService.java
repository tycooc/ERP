...
public interface AssetIService extends BaseIService<Asset>
{
	 ...
	 * @return
	 */
	InputStream exmportExcel(String isAllPage, PageUtil<Asset> pageUtil)throws fxtException;
	 ...
	 * @throws fxtException
	 */
	InputStream importExcel(File assetFile, int isCheck)throws fxtException;
}
